...
export BASE_DATASETS_DIR="/mnt/data/data/yanzj/workspace/dataset"  # E.g., `/home/user/data/` if `LIBERO-Cosmos-Policy` is in this directory
# export BASE_DATASETS_DIR="/data/yanzj/workspace/dataset"
